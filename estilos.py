...
# grados de certeza.
#
# OJO: todo el HTML que devuelven estas funciones sale en UNA SOLA LINEA y sin
# sangria. Si se parte en varias lineas indentadas, Streamlit lo interpreta
# como bloque de codigo Markdown y lo muestra como texto en vez de renderizarlo.
MARCA_SVG = (
    '<svg width="30" height="30" viewBox="0 0 30 30" fill="none" '
    'xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Payments LAC">'
